...
export const watches: Product[] = [
  {
    ...
    category: 'watches',
    description: 'The Chronograph Elite represents the pinnacle of watchmaking artistry. Meticulously crafted with a 316L stainless steel case and scratch-resistant sapphire crystal, this timepiece is built to last generations. The automatic movement beats at 28,800 vibrations per hour, ensuring accuracy within +/- 5 seconds per day. Each detail has been thoughtfully considered—from the luminous hands that glow in darkness to the exhibition caseback revealing the intricate mechanical heart within. The genuine Italian leather strap develops a beautiful patina over time, making your watch uniquely yours.',
    details: [
      'Swiss Automatic Movement, 28,800 VPH',
      'Sapphire Crystal with Anti-Reflective Coating',
      '42mm Case Diameter, 12mm Thickness',
